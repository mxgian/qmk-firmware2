...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LCTL,       KC_LALT,       KC_LGUI,  LT(2, KC_ENT),    LT(1, KC_SPC),        MO(3),          KC_RGUI, KC_RCTL
  ),
  ...
  [3] = LAYOUT(
    KC_TRNS, KC_F1,   KC_UP,  KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
