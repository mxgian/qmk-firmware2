...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
    ...
    KC_LSFT,       KC_Z,    KC_X, KC_C,     KC_V,    KC_B,    LT(3, KC_B), KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,
    KC_LCTL,       KC_LALT,       KC_LGUI,  LT(2, KC_ENT),    LT(1, KC_SPC),        MO(3),          MT(KC_RGUI,KC_LEFT), MT(KC_RCTL,KC_RIGHT)
  ),
  ...
  [3] = LAYOUT(
    KC_TRNS, KC_F1,   KC_UP,  KC_F3,   KC_F4,   KC_F5,       KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  RESET,  KC_TRNS,
    KC_TRNS, KC_LEFT, KC_DOWN, KC_RIGHT, KC_TRNS, KC_TRNS,     KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TRNS, KC_TRNS,
    KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6,     KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_VOLD, KC_VOLU,
