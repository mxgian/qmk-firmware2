...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
    ...
    KC_LCTL, KC_LCTRL, KC_LALT, KC_LGUI,         LOWER,   KC_SPC ,LT(_LOWER,KC_ENT),       LT(_RAISE,KC_SPC),KC_SPC , RAISE, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
  ),
  /* Lower
   * ,----------------------------------------------------------------------------------------------------------------------.
  ...
  [_LOWER] = LAYOUT(
    ...
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_COLN, KC_DQT , \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_SPC , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_LALT, KC_LGUI, EISU,             LOWER,   KC_SPC ,KC_ENT,          KC_SPC,KC_SPC , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
  ...
  [_RAISE] = LAYOUT(
    KC_F11,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_LCBR,                        KC_RCBR, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F12,  \
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_DLR,  KC_PERC, KC_UNDS,                        KC_PLUS, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE, \
    KC_TAB,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_DEL ,                        KC_BSPC, KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSLS, KC_DQT , \
    KC_LSFT, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_SPC ,                        KC_SPC , KC_N,    KC_M,    KC_LT,   KC_GT,   KC_QUES, KC_RSFT, \
    KC_LCTL, KC_LGUI, KC_LALT, EISU,             LOWER,   KC_SPC ,KC_ENT,          KC_SPC,KC_SPC , RAISE,            KC_HOME, KC_PGDN, KC_PGUP, KC_END   \
  ),
